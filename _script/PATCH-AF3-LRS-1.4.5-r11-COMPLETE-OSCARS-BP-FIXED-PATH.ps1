...
$PatchVersion = "1.4.5-r11-complete-oscars-bp-fixed-path"
...
Write-Host "============================================================"
Write-Host "AF3 + LRS 1.4.5 Complete Oscar Best Picture XML Patch ($PatchVersion)"
Write-Host "============================================================"
Write-Host "Skin 1080i path:"
Write-Host "  $Skin1080i"
Write-Host ""
Write-Host "Pilih aksi:"
Write-Host "  1. Patch complete fixed-path Oscar BP variables"
